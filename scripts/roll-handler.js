export let wwnRollHandler = null

Hooks.once('tokenActionHudCoreApiReady', async (coreModule) => {
  wwnRollHandler = class WWNRollHandler extends coreModule.api.RollHandler {
    /**
     * Handle Action Event
     * @override
     * @param {object} event
      ...
      switch (actionType) {
        ...
        case 'misc':
          if (this.isRenderItem()) this.doRenderItem(actor, actionId)
            ...
            new Dialog({
              title: coreModule.api.Utils.i18n('tokenActionHud.wwn.consume_dialog.title'),
              content: `${coreModule.api.Utils.i18n('tokenActionHud.wwn.consume_dialog.content')}<br /><input id="quantityID" type="number" value="1" />`,
              buttons: {
                button1: {
                  label: "Yes",
